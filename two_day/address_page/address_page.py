...
class AddressPage:
    ...
    def add_member(self):
        ...
        self.driver.find_element(By.XPATH, "//*[@id='memberAdd_acctid']").send_keys("zhoushengsheng")
        self.driver.find_element(By.XPATH, "//*[@id='memberAdd_phone']").send_keys("15789890000")
